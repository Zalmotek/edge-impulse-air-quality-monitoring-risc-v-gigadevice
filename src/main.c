...
void sensor_loop() {
    ...
    while (1)
    {
       ...
       pres = (int)(bme_data.pressure/10000);
       temp = (int)bme_data.temperature;
       hum = (int)bme_data.humidity;
    //    display_line(0, "", bme_data.pressure, "", ser_line, (bme_data.pressure > 70000 && bme_data.pressure < 119000));
    //    display_line(1, "", bme_data.humidity, "", ser_line, (bme_data.humidity > 20 && bme_data.humidity < 80));
    //    display_line(2, "", bme_data.temperature, "", ser_line, (bme_data.temperature > 0 && bme_data.temperature < 70));
    printf("%d\t",pres);
